...
class FavoriteRecipeAdapter(
    ...
    private val TAG="FavoriteRecipeAdapter"
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        currentBinding = holder.binding

        val currentRecipe = favoriteFoodResults[position]
    ...
    private fun applySelection(
        ...
        if (selectedRecipes.contains(currentRecipes)) {
            ...
            changeRecipeStyle(viewHolder, R.color.cardBackgroundColorLight, R.color.purple_500)
            applyActionModeTitle()
        }
    }
